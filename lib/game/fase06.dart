...
class Fase06 extends StatefulWidget {
  const Fase06({super.key});

  @override
  State<Fase06> createState() => _Fase06State();
}

class _Fase06State extends State<Fase06> {
  ...
  Widget build(BuildContext context) {
    return BonfireWidget(
      ...
      map: WorldMapByTiled(
        WorldMapReader.fromAsset('map/fase_6.tmj'),
