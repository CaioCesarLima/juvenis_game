...
class Fase10 extends StatefulWidget {
  const Fase10({super.key});

  @override
  State<Fase10> createState() => _Fase10State();
}

class _Fase10State extends State<Fase10> {
  ...
  Widget build(BuildContext context) {
    return BonfireWidget(
      ...
      map: WorldMapByTiled(
        WorldMapReader.fromAsset('map/fase_10.tmj'),
